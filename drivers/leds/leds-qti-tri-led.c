...
static u64 back_duty_pattern[LPG_LUT_COUNT_MAX + 1] = { 0 };	//for reback the duty pattern status
				    ...
				    const char *buf, size_t count)
{
	...
	LED_DEBUG
	    ("breath_mode=%d, fade_time=%d fullon_time=%d fulloff_time=%d min_grade=%d max_grade=%d\n",
